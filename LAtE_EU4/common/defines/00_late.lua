...
NDefines.NFrontend.CAMERA_LOOKAT_SETTINGS_X = 1300.0 				-- Rotation point in settings
NDefines.NFrontend.CAMERA_LOOKAT_SETTINGS_Y = 0.0					-- Y is height
NDefines.NFrontend.CAMERA_LOOKAT_SETTINGS_Z = 1519.0
NDefines.NFrontend.CAMERA_START_X = 1300.0						-- Initial position in main menu
NDefines.NFrontend.CAMERA_START_Y = 800							-- Y is height
NDefines.NFrontend.CAMERA_START_Z = 1400.0
NDefines.NFrontend.CAMERA_END_X = 1300.0							-- Move to position in main menu
